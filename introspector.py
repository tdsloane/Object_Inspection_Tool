...
"""
The goal of this program is to create a function which when passed a single object
prints out a nicely formatted dump of that object's attributes and methods.
"""

def dump(obj):
    """
    Prints an outline of an objects dump.
    """
    print()
    print("Type")
    print("====")
    ...
    print_table(method_names_and_doc, "Name", "Descrption")
    print()
